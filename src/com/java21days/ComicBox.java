...
public class ComicBox {
    ...
    public ComicBox() {
        ...
        comix[0] = new InnerComic("Wspaniały Spider-Man", "1A", "bardzo dobry",
            12_000.00F);
        comix[0].setPrice( (Float) quality.get(comix[0].condition) );
        comix[1] = new InnerComic("Niesamowity Hulk", "181", "prawie jak nowy",
            680.00F);
        comix[1].setPrice( (Float) quality.get(comix[1].condition) );
        comix[2] = new InnerComic("Cerebus", "1A", "średni", 190.00F);
